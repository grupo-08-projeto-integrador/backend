      ...
      <section class="checkout">
        ...
        <div class="itens-checkout">
          <span class="item1 cont-item-checkout">
            ...
            <div class="qtde-checkout FGtam2">
              <button id="btnmenos-checkout" @click="decrementCounter">-</button>
              <span id="qtdeitens-checkout">
                <p>Qt: </p>
                <input type="text" :value="counterValue" disabled id="counterValue">
              </span>
              <button id="btnmais-checkout" @click="incrementCounter">+</button>
            </div>
        ...
        <div class="divbtnpf-checkout">
          <div id="btnFP">
            ...
            <p id="aviso">Ao clicar no botão acima, você será redirecionado(a) para nosso WhatsApp e nosso atendimento finalizará o seu pedido</p>
          </div>
          <div>
            <button class="btnFP-checkout">REALIZAR CADASTRO</button>
            <p id="aviso">Ainda não possui cadastro? Cadastre em nossa Loja Virtual.</p>
          </div>
        </div>
      </section>
    </div>
...
<script>
export default {
  // ...suas configurações de componente...
